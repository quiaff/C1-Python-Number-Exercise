...
class Fraccion(Numero):
    ...
    def __init__(self, numerador, denominador):
        if denominador.esUno():
            raise Exception("El denominador no puede ser 1")
    ...
    def __div__(self,divisor):
        return (self.numerador() * divisor._denominador) / (self.denominador () * divisor._numerador)
